...
class ResConfigSettings(models.TransientModel):
    ...
    documents_purchase_settings = fields.Boolean(related='company_id.documents_purchase_settings', readonly=False,
                                                string="Purchase")
    purchase_folder = fields.Many2one('documents.folder', related='company_id.purchase_folder', readonly=False,
                                     string="Purchase default workspace")
    purchase_tags = fields.Many2many('documents.tag', 'purchase_tags_table',
                                    related='company_id.purchase_tags', readonly=False,
